...
import StudentGradeManagement from './StudentGradeManagement';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'analytics' | 'payments' | 'sessions' | 'assignments' | 'messaging' | 'grades' | 'reports' | 'moderation' | 'settings'>('overview');
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6">
        ...
        <div className="p-6">
          ...
          {activeTab === 'grades' && <StudentGradeManagement adminId={admin.id} />}
