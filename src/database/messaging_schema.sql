-- TutorHub Messaging System Database Schema
...
CREATE TABLE IF NOT EXISTS conversations (
    ...
    -- Ensure unique conversation per student-tutor pair
...
CREATE TABLE IF NOT EXISTS message_reads (
    ...
    -- Ensure unique read status per message-user pair
...
CREATE TABLE IF NOT EXISTS conversation_participants (
    ...
    -- Ensure unique participation per conversation-user pair
...
VALUES (
    ...
    (SELECT id FROM auth.users WHERE email LIKE '%tutor%' LIMIT 1),
    'Mathematics'
);
...
VALUES (
    ...
    (SELECT student_id FROM conversations LIMIT 1),
