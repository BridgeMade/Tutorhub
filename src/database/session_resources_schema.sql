-- Session Resources Integration Schema
...
-- Function to generate automatic resource suggestions for a session
...
BEGIN
    ...
    GET DIAGNOSTICS suggestion_count = suggestion_count + ROW_COUNT;
...
/*
-- Example of assigning a resource to a session
INSERT INTO session_resources (session_id, resource_id, assigned_by, assignment_type, is_required, notes)
SELECT 
    l.id as session_id,
    r.id as resource_id,
    l.tutor_id as assigned_by,
    'preparation' as assignment_type,
    true as is_required,
    'Please review this before our session' as notes
FROM lessons l
